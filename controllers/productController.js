...
const productController = {
    ...
    product: function(req, res) {
        let id = req.params.id; // obetenes al parametro que ingreso el usuario dentro de la rota,  osea el producto que yo toque con la imagen, osea el id del producto.
